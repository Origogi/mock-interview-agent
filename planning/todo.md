...
> **🔜 Next Up (5-14 시작):** BE 개발자에게 **M8 (`max_questions` 의미 재정의, 옵션 A)** 구현 플랜 작성 디스패치 — Plan First, 코드 변경 X. M2와 동일 PR 묶음 검토.
...
| **5-12~5-13** | 월~화 | **M2 빈 답변/질문 가드 + M8 `max_questions` 의미 재정의 (묶음)** | 1일 | BE |
...
- [ ] **M8: `max_questions` 의미 재정의 (옵션 A)** → **[features.md M8]** / **예정: 5-12~5-13 (M2 묶음)**
