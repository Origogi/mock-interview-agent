...
| **5-11~5-12** | 일~월 | **[~] M5 Page 3 메시지 자동 스크롤** 🔄 (세션: FE-M5-autoscroll, since: 2026-05-10) | 1일 | FE |
...
- [~] **M5: Page 3 메시지 자동 스크롤** → **[features.md M5]** / **진행 중 (2026-05-10 PM 회의 합의, 라이브러리 use-stick-to-bottom 도입)**
